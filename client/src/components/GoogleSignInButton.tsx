...
const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
  ...
  const handleButtonClick = () => {
    ...
    // Use Google's renderButton method for a more reliable sign-in experience
    try {
      ...
      // Auto-click the hidden Google button
      setTimeout(() => {
        const googleButton = tempContainer.querySelector('div[role="button"]') as HTMLElement;
        if (googleButton) {
          googleButton.click();
        } else {
          // Fallback to prompt if renderButton doesn't work
      ...
      try {
        ...
        toast({
          variant: 'destructive',
          title: 'Sign-In Error',
          description: 'Unable to initialize Google Sign-In. Please check if you have a valid Google Client ID configured.',
        });
      }
    }
  };
